        ...
        top=bar.Bar(
            ...
            # Left side
                ...
                widget.GroupBox(
                    ...
                    foreground='#4B427E',
                    background='#3f4243',
                    this_current_screen_border='#3f4243',
                    this_screen_border='#3f4243',
                    other_current_screen_border='#3f4243',
                    other_screen_border='#3f4243',
                    urgent_border='#3f4243',
                    rounded=True,
                    disable_drag=True,
                 ),
