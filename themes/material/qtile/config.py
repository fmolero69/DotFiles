    ...
    Screen(
        top=bar.Bar(
            ...
            # Left side
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img1.png',
                ),
                ...
                widget.GroupBox(
                    ...
                    active="#29a2c0",
                    block_highlight_text_color='#025d74',
                    highlight_color='#4B427E',
                    inactive='#76b3c2',
                    foreground='#4B427E',
                    background='#ffe680',
                    this_current_screen_border='#ffe680',
                    this_screen_border='#ffe680',
                    other_current_screen_border='#ffe680',
                    other_screen_border='#ffe680',
                    urgent_border='#ffe680',
                    rounded=True,
                    disable_drag=True,
                 ),
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img2.png',
                ),
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img3.png',
                ),
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img4.png',
                ),
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img5.png',
                ),
            ...
            # Right side
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img6.png',
                    background='#37abc8',
                ),
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img7.png',
                ),
                widget.TextBox(
                    font="Font Awesome 6 Free",
                    fontsize=10,
                ...
                widget.CheckUpdates(
                    ...
                    colour_have_updates = "fa8e08",
                    no_update_string='No updates',
                    colour_no_updates='025d74',
                    update_interval = 30,
                ),
                ...
                widget.Image(
                    filename='~/.config/qtile/Assets/img8.png',
                    background='#87cdde',
                ),
